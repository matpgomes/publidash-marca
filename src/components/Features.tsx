          ...
          {features.map((feat, i) => {
            ...
            return (
              <motion.div
                ...
                className="bg-surface-1 rounded-2xl border border-border p-6 hover:border-violet-500/30 hover:shadow-sm transition-all"
              >
                <div className="w-10 h-10 rounded-lg flex items-center justify-center mb-4 bg-violet-50">
                  <Icon
                    size={20}
                    strokeWidth={1.5}
